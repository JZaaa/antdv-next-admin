export default {
  ...
  login: {
    ...
    entering: 'Opening your workspace, please wait…',
    enterFailed: 'You are signed in, but the page could not load. Please try again.',
    retryEntering: 'Try opening workspace again',
