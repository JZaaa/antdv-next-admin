<template>
  <article
    class="relative overflow-hidden min-h-[168px] !p-5 rounded-[var(--radius-lg)] border border-[var(--color-border-secondary)] bg-[var(--color-bg-container)] shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-card-hover md:min-h-[150px]"
  >
